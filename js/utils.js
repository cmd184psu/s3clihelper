...
function onBlur() {
	//this field is r/o
	config_in_mem.admin.endpoint=$("#inputAdminEndpoint").val();
	...
	config_in_mem.s3api.endpoint=$("#inputS3Endpoint").val();
	...
	config_in_mem.s3api.bucket=$("#inputBucketName").val();
  	config_in_mem.s3api.objectKey=$("#inputObjectName").val();
...
function onRefresh() {
	...
	$("#inputBucketName").val(config_in_mem.s3api.bucket);
  	$("#inputObjectName").val(config_in_mem.s3api.objectKey);
